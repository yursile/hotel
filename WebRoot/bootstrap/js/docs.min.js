...
! function(a, b, c) {
	b[a] = c
}("onDomReady", this, function(a) {"use strict";
	function b(a) {
		if (!v) {
			if (!g.body)
				return e(b);
	...
	var x = "http://www.w3.org/2000/svg", y = b.document, z = {
		addTheme : function(a, b) {
			...
			delete A.vars.cache.themeKeys, this
		},
...
! function(a) {"use strict";
	...
	var d, e = {
		...
		return this instanceof K ? (this.id = "" + g++, h[this.id] = {
			...
			elements : [],
			handlers : {}
		}, a && this.clip(a), "undefined" != typeof b && (C("new ZeroClipboard(elements, options)", N.debug), K.config(b)), this.options = K.config(), "boolean" != typeof e.disabled && (e.disabled = !J()),
		void (e.disabled === !1 && e.outdated !== !0 && null === e.bridge && (e.outdated = !1, e.ready = !1, O()))) : new K(a, b)
	};
